...
struct network_libpm;
typedef struct network_libpm network_libpm;
...
struct layer_libpm;
typedef struct layer_libpm layer_libpm;
...
typedef struct checkpoint_args checkpoint_args;
...
struct checkpoint_args{
    ...
    int* cutoff;
    int* save_ema;
    int is_initial_checkpoint;
    struct container* cont;
    unsigned int* container_number;
    double *pull_time;
    double *cp_time;
    int *cp_phase;
    double* flush_time;
...
// network.h
typedef struct  network_libpm{
    int n;
    layer_libpm **layers_libpm;
    int major;
    int minor;
    int revision;
    uint64_t seen;
